...
<template>
  ...
  <div id="top" class="h-screen dark:(bg-black text-white) pt-3rem ">
    <div class="w-screen my-5rem inline-flex justify-center items-center">
      <button id="reset" @click="power('reset', errorFn())" class="transition button mx-5rem !mobile">
      ...
      <button id="reboot" @click="power('reboot', errorFn())" class="transition button mx-5rem !mobile">
      ...
      <button id="power" @click="power('power', errorFn())" class="transition button mx-5rem !mobile">
